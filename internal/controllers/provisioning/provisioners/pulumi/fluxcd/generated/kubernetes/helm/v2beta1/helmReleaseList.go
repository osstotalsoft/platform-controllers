...
func NewHelmReleaseList(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:helm.toolkit.fluxcd.io/v2beta1:HelmReleaseList", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHelmReleaseList(ctx *pulumi.Context,
	...
	var resource HelmReleaseList
	err := ctx.ReadResource("kubernetes:helm.toolkit.fluxcd.io/v2beta1:HelmReleaseList", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
