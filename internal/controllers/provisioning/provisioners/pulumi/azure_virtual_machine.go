...
func deployAzureVirtualMachine(target provisioning.ProvisioningTarget,
	resourceGroupName pulumi.StringOutput,
	azureVM *provisioningv1.AzureVirtualMachine,
	dependencies []pulumi.Resource,
	ctx *pulumi.Context) (*compute.VirtualMachine, error) {
	...
	vm, err := compute.NewVirtualMachine(ctx, vmName, &args, pulumi.DependsOn(dependencies))
	if err != nil {
		return nil, err
	}
