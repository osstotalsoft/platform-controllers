...
// apply.
func ValueExport() *ValueExportApplyConfiguration {
	return &ValueExportApplyConfiguration{}
}

// WithToConfigMap sets the ToConfigMap field in the declarative configuration to the given value
// and returns the receiver, so that objects can be built by chaining "With" function invocations.
// If called multiple times, the ToConfigMap field is set to the value of the last call.
func (b *ValueExportApplyConfiguration) WithToConfigMap(value *ConfigMapTemplateApplyConfiguration) *ValueExportApplyConfiguration {
	b.ToConfigMap = value
	return b
}

// WithToVault sets the ToVault field in the declarative configuration to the given value
// and returns the receiver, so that objects can be built by chaining "With" function invocations.
