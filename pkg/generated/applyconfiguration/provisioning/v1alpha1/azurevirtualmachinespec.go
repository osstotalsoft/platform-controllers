...
func (b *AzureVirtualMachineSpecApplyConfiguration) WithCategoryOverrides(entries map[string]*v1.JSON) *AzureVirtualMachineSpecApplyConfiguration {
...
func (b *AzureVirtualMachineSpecApplyConfiguration) WithDependsOn(values ...*ProvisioningResourceIdendtifierApplyConfiguration) *AzureVirtualMachineSpecApplyConfiguration {
	for i := range values {
		if values[i] == nil {
