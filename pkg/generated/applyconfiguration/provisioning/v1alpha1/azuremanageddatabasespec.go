...
func (b *AzureManagedDatabaseSpecApplyConfiguration) WithTarget(value *ProvisioningTargetApplyConfiguration) *AzureManagedDatabaseSpecApplyConfiguration {
	b.Target = value
	return b
}
...
func (b *AzureManagedDatabaseSpecApplyConfiguration) WithDependsOn(values ...*ProvisioningResourceIdendtifierApplyConfiguration) *AzureManagedDatabaseSpecApplyConfiguration {
	for i := range values {
		if values[i] == nil {
