...
// HelmReleaseV2SpecApplyConfiguration represents an declarative configuration of the HelmReleaseV2Spec type for use
// with apply.
type HelmReleaseV2SpecApplyConfiguration struct {
	Release                            *v2.HelmReleaseSpec                          `json:"release,omitempty"`
	Exports                            []HelmReleaseV2ExportsSpecApplyConfiguration `json:"exports,omitempty"`
	ProvisioningMetaApplyConfiguration `json:",inline"`
}

// HelmReleaseV2SpecApplyConfiguration constructs an declarative configuration of the HelmReleaseV2Spec type for use with
// apply.
func HelmReleaseV2Spec() *HelmReleaseV2SpecApplyConfiguration {
	return &HelmReleaseV2SpecApplyConfiguration{}
}
...
func (b *HelmReleaseV2SpecApplyConfiguration) WithRelease(value v2.HelmReleaseSpec) *HelmReleaseV2SpecApplyConfiguration {
	b.Release = &value
	return b
}
...
func (b *HelmReleaseV2SpecApplyConfiguration) WithExports(values ...*HelmReleaseV2ExportsSpecApplyConfiguration) *HelmReleaseV2SpecApplyConfiguration {
	for i := range values {
		if values[i] == nil {
...
func (b *HelmReleaseV2SpecApplyConfiguration) WithPlatformRef(value string) *HelmReleaseV2SpecApplyConfiguration {
	b.PlatformRef = &value
	return b
}
...
func (b *HelmReleaseV2SpecApplyConfiguration) WithDomainRef(value string) *HelmReleaseV2SpecApplyConfiguration {
	b.DomainRef = &value
	return b
}
...
func (b *HelmReleaseV2SpecApplyConfiguration) WithCategoryOverrides(entries map[string]*v1.JSON) *HelmReleaseV2SpecApplyConfiguration {
...
func (b *HelmReleaseV2SpecApplyConfiguration) WithTenantOverrides(entries map[string]*v1.JSON) *HelmReleaseV2SpecApplyConfiguration {
...
func (b *HelmReleaseV2SpecApplyConfiguration) WithTarget(value *ProvisioningTargetApplyConfiguration) *HelmReleaseV2SpecApplyConfiguration {
	b.Target = value
	return b
}
...
func (b *HelmReleaseV2SpecApplyConfiguration) WithDependsOn(values ...*ProvisioningResourceIdendtifierApplyConfiguration) *HelmReleaseV2SpecApplyConfiguration {
	for i := range values {
		if values[i] == nil {
