...
func (b *AzureDatabaseExportsSpecApplyConfiguration) WithUserRef(value string) *AzureDatabaseExportsSpecApplyConfiguration {
	b.UserRef = &value
	return b
}
...
func (b *AzureDatabaseExportsSpecApplyConfiguration) WithIdentityRef(value string) *AzureDatabaseExportsSpecApplyConfiguration {
	b.IdentityRef = &value
	return b
}
