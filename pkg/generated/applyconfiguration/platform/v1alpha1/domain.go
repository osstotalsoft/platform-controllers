...
// DomainApplyConfiguration represents an declarative configuration of the Domain type for use
// with apply.
...
// Domain constructs an declarative configuration of the Domain type for use with
// apply.
