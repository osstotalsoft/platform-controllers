...
// apply.
func ProvisioningResourcePatch() *ProvisioningResourcePatchApplyConfiguration {
...
func (b *ProvisioningResourcePatchApplyConfiguration) WithSpec(value v1.JSON) *ProvisioningResourcePatchApplyConfiguration {
	b.Spec = &value
	return b
}
