	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ProvisioningV1alpha1().HelmReleases(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ProvisioningV1alpha1().HelmReleases(namespace).Watch(context.TODO(), options)
			},
		},
		&provisioningv1alpha1.HelmRelease{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *helmReleaseInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&provisioningv1alpha1.HelmRelease{}, f.defaultInformer)
}
