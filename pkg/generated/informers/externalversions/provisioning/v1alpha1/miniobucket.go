	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ProvisioningV1alpha1().MinioBuckets(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ProvisioningV1alpha1().MinioBuckets(namespace).Watch(context.TODO(), options)
			},
		},
		&provisioningv1alpha1.MinioBucket{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *minioBucketInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&provisioningv1alpha1.MinioBucket{}, f.defaultInformer)
}
