...
type ServiceInterface interface {
	...
	Apply(ctx context.Context, service *platformv1alpha1.ServiceApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Service, err error)
	ServiceExpansion
}
...
func newServices(c *PlatformV1alpha1Client, namespace string) *services {
	return &services{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *services) Apply(ctx context.Context, service *platformv1alpha1.ServiceApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Service, err error) {
	if service == nil {
