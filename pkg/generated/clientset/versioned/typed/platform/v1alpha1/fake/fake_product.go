...
var productsKind = v1alpha1.SchemeGroupVersion.WithKind("Product")
...
func (c *FakeProducts) Apply(ctx context.Context, product *platformv1alpha1.ProductApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Product, err error) {
	if product == nil {
