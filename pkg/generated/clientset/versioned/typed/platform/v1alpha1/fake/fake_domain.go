...
func (c *FakeDomains) Apply(ctx context.Context, domain *platformv1alpha1.DomainApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Domain, err error) {
	if domain == nil {
	...
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(domainsResource, c.ns, *name, types.ApplyPatchType, data), &v1alpha1.Domain{})
