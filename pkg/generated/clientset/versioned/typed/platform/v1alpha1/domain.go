...
type DomainInterface interface {
	...
	Apply(ctx context.Context, domain *platformv1alpha1.DomainApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Domain, err error)
	DomainExpansion
}
...
func newDomains(c *PlatformV1alpha1Client, namespace string) *domains {
	return &domains{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *domains) Apply(ctx context.Context, domain *platformv1alpha1.DomainApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Domain, err error) {
	if domain == nil {
