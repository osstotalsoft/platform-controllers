...
type ProductInterface interface {
	...
	Apply(ctx context.Context, product *platformv1alpha1.ProductApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Product, err error)
	ProductExpansion
}
...
// Apply takes the given apply declarative configuration, applies it and returns the applied product.
func (c *products) Apply(ctx context.Context, product *platformv1alpha1.ProductApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Product, err error) {
	if product == nil {
		return nil, fmt.Errorf("product provided to Apply must not be nil")
	}
